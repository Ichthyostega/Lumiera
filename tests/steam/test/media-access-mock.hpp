 ...
 ** @deprecated 2026 left in-tree as reference -- expected to be superseded
 **       with the »Load Clip« vertical slice
 */


#ifndef STEAM_TEST_MEDIA_ACCESS_MOCK_H
#define STEAM_TEST_MEDIA_ACCESS_MOCK_H
