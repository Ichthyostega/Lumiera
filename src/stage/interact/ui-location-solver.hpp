          ...
          for (auto& clause : rule)
            {
              ...
              if (not isnil(resolver)                     // Solution found!
                       ...
                       or resolver.isCoveredTotally())) //   while in the default case we demand complete coverage
                {
                  ...
                  return move (resolver);  //////////////////////////////////////////////////////////////////TICKET #1402 : need a better solution for the builder-terminal-op. (it collides with the templated UICoord ctor) |NOTE: the compiler warning is wrong here, the move() is essential
