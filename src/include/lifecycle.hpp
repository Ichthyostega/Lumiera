/*
  LIFECYCLE.hpp  -  interface for registering and triggering lifecycle callbacks
 ...
 ** This service is a facade for and implemented by the vessel::LifecycleRegistry.
...
#ifndef VESSEL_LIFECYCLE_H
#define VESSEL_LIFECYCLE_H
