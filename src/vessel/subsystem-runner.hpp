 ...
 ** vessel::Voyage::init() for actually "performing" the various subsystems,
 ** as defined by their [Subsystem descriptors](\ref vessel::Subsys). Together
...
#ifndef VESSEL_SUBSYSTEMRUNNER_H
#define VESSEL_SUBSYSTEMRUNNER_H
...
namespace vessel {
   ...
   * The SubsystemRunner is to be configured with a vessel::Option object first.
...
#endif /*VESSEL_SUBSYSTEMRUNNER_H*/
