 ...
 ** The [Defaults Manager](\ref vessel::query::DefsManager) exposes an interface
...
#ifndef VESSEL_QUERY_DEFS_MANAGER_H
#define VESSEL_QUERY_DEFS_MANAGER_H
...
//          >
//        SMP<TAR> operator() (const vessel::Query<TAR>&);
...
#endif /*VESSEL_QUERY_DEFS_MANAGER_H*/
