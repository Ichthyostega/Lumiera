...
#ifndef VESSEL_QUERY_DEFS_MANAGER_IMPL_H
#define VESSEL_QUERY_DEFS_MANAGER_IMPL_H
...
namespace query  {
  ...
  DefsManager::operator() (const Query<TAR>& capabilities)
  {
    ...
    if (!res)
      throw err::Config (_Fmt("The following Query could not be resolved: %s.")
...
#endif /* VESSEL_QUERY_DEFS_MANAGER_IMPL_H */
