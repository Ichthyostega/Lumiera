 ...
 ** The vessel::spine::Config wrapper class addresses two issues.
 ...
 **       But the full-blown Config system isn't implemented yet anyway  ////////////////////////////////////TICKET #1224 : Call for Design -- Layered Configuration System
 ** 
 ** @see config.h
 ** @see vessel::Voyage
 ** @see main.cpp
...
#ifndef VESSEL_SPINE_CONFIGFACADE_H
#define VESSEL_SPINE_CONFIGFACADE_H
...
#endif /*C++ vs C*/
#endif /*VESSEL_SPINE_CONFIGFACADE_H*/
