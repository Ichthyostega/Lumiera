 ...
 ** vessel::facade::Proxy to drive instantiation of the actual binding proxy.
 ...
 ** it automatically attempts to instantiate a vessel::facade::Proxy templated to the actual type
 ...
 ** needs to specialise vessel::facade::Proxy and then create an instance of that template.
...
#ifndef VESSEL_INTERFACE_PROXY_H
#define VESSEL_INTERFACE_PROXY_H
...
#endif /*VESSEL_INTERFACE_PROXY_H*/
