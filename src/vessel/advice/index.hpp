 ...
 ** To support the **Advice** collaboration, it is necessary to match advice requests with
 ...
 ** It is _not usable as an external interface_. But it is written in a rather self-contained manner,
...
#ifndef VESSEL_ADVICE_INDEX_H
#define VESSEL_ADVICE_INDEX_H
...
#include "vessel/advice/binding.hpp"
...
}} // namespace vessel::advice
#endif /*VESSEL_ADVICE_INDEX_H*/ 
