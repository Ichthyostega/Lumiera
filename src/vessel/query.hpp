 ...
 ** 
 ** To resolve the query, a vessel::QueryResolver instance is necessary, and this
...
#ifndef VESSEL_QUERY_H
#define VESSEL_QUERY_H
...
namespace vessel {
   ...
   * 
   * @remarks vessel::Query is an interface, but can be used as-is to represent a generic query.
