...
#ifndef VESSEL_CONFIG_RULES_H
#define VESSEL_CONFIG_RULES_H
...
#define SYMBOL uint
     ...
     * @see vessel::query::LookupPreconfigured
     * @see vessel::query::MockTable
     */
    template<class TY>
    class QueryHandler
      {
  ...
  namespace query {
    ...
    void setFakeBypass(vessel::QueryKey const& q);
    bool isFakeBypass (vessel::QueryKey const& q);
    /////////////////////////////////////////////////////////////////////////////TICKET 710
    
  } // namespace query
  
} // namespace vessel
#endif /*VESSEL_CONFIG_RULES_H*/
