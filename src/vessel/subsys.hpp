 ...
 ** to be brought down in a clean manner. The purpose of vessel::Subsys is
...
#ifndef VESSEL_SUBSYS_H
#define VESSEL_SUBSYS_H
...
namespace vessel {
   ...
   * After launch from the main() function, the vessel::Voyage uses these descriptors
   * to pull up, maintain and shut down the primary parts of the Lumiera application.
  ...
  class Subsys
    ...
    public:
      ...
      virtual bool shouldStart (vessel::Option&)  =0;
      ...
      virtual bool start (vessel::Option& options, SigTerm)  =0;
